...
public interface DataPolygon<T> extends Geometry {
    ...
    /**
     * Gets a list of outer boundary coordinates
     *
     * @return list of outer boundary coordinates
     */
    List<LatLng> getOuterBoundaryCoordinates();

    /**
     * Gets a list of lists of inner boundary coordinates
     *
     * @return list of lists of inner boundary coordinates
     */
